    ...
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        ...
        <nav>
          ...
          <a className="link link-hover  text-white">Offers</a>
          <a href="/menu"className="link link-hover text-white">Menus</a>
          <a className="link link-hover  text-white">Reservation</a>
        </nav>
        <nav>
          <header className="footer-title  text-white">Contact Us</header>
          <a className="link link-hover  text-white">example@email.com</a>
          <a className="link link-hover  text-white">+64 958 248 966</a>
          <a className="link link-hover  text-white">Social media</a>
        </nav>
      </footer>
        <hr />
